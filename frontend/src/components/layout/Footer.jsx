      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <Vote className="h-6 w-6 text-trustblue-600" />
              <span className="text-lg font-bold text-trustblue-700">
                ElectTrust<span className="text-secure-700">Ledger</span>
              </span>
            </div>
            <p className="text-sm text-gray-600 mb-4">
              A secure, transparent blockchain-based voting platform that ensures
              the integrity of every election.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-trustblue-500">
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-base text-gray-400">
            &copy; {new Date().getFullYear()} ElectTrustLedger. All rights reserved.
          </p>
